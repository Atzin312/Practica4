...
////////////////////////////////////////////////////////////////////////////////
defined('DATABASE_HOST') ? NULL : define('DATABASE_HOST', 'db4free.net');
defined('DATABASE_NAME') ? NULL : define('DATABASE_NAME', 'directorio');
defined('DATABASE_USER') ? NULL : define('DATABASE_USER', 'atzin312');
defined('DATABASE_PASSWORD') ? NULL : define('DATABASE_PASSWORD', 'halo3eslopeor');
